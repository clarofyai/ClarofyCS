...
You can install the released version of ClarofyCS from [CRAN](https://CRAN.R-project.org) with:
...
```{r}
install.packages("ClarofyCS", repos = "https://github.com/clarofy/ClarofyCS", type="source")
